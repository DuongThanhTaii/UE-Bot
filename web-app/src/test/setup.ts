...
const mockServiceHub = {
  ...
  voice: () => ({
    ...
    submitAudioChunk: vi.fn().mockResolvedValue({}),
    submitTranscript: vi.fn().mockResolvedValue({}),
    playTTSAudio: vi.fn().mockResolvedValue({}),
    setOutputState: vi.fn().mockResolvedValue({}),
    getRecentVoiceEvents: vi.fn().mockResolvedValue([]),
  }),
}
