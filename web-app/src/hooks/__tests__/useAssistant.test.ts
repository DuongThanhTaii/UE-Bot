...
describe('useAssistant', () => {
  ...
  it('should delete assistant', () => {
    ...
    expect(result.current.assistants[0].id).toBe('ue-bot')
  })
  ...
  it('should maintain assistant structure', () => {
    ...
    expect(result.current.currentAssistant.id).toBe('ue-bot')
    expect(result.current.currentAssistant.name).toBe('UE Bot')
