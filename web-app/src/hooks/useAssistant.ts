...
export const defaultAssistant: Assistant = {
  ...
  avatar: '👋',
  description:
    "UE Bot is a helpful desktop assistant that can reason through complex tasks and use tools to complete them on the user's behalf.",
  instructions: `You are UE Bot, a helpful AI assistant who assists users with their requests.
