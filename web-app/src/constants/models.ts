...
export const RECOMMENDED_MODEL_HF_REPO =
  'janhq/Jan-v3-4B-base-instruct-gguf'
export const RECOMMENDED_MODEL_DISPLAY_NAME = 'UE Bot Core 4B'
export const RECOMMENDED_MODEL_MATCH_TERMS = ['jan-v3-4b-base-instruct', 'jan-v3']
 ...
 */
export const SETUP_SCREEN_QUANTIZATIONS = ['q4_k_xl', 'q4_k_m', 'q4_k_s']
