  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        '@janhq/tauri-plugin-rag-api': path.resolve(
          __dirname,
          '../src-tauri/plugins/tauri-plugin-rag/guest-js/index.ts'
        ),
        '@janhq/tauri-plugin-vector-db-api': path.resolve(
          __dirname,
    ...
    define: {
      ...
      IS_WEB_APP: JSON.stringify(!isTauriBuild),
      ...
      AUTO_UPDATER_DISABLED: JSON.stringify(
        env.AUTO_UPDATER_DISABLED !== 'false'
      ),
